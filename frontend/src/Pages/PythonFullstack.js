...
export default function PythonFullstack() {
    return (
        <div>
            ...
            <div class="container">
                <h1 class="center">Python full Stack</h1><br /><br /><br />
                <div class="row ">
                    ...
                    <div class="col-sm-4 d-flex flext-column  justify-content-center kl fullborder animate__animated animate__bounceInRight">
                        ...
                        <div className='bull '>
                            ...
                            <img src='assets/img/mysql.png' className='img-1 ' />
                            <img src='assets/img/oracle.png' className='img-2' />
                            {/* <img src='assets/img/java-script.png' className='img-8' /> */}
                            <img src='assets/img/sql-server.png' className='img-9' />
                            <img src='assets/img/mongodb.png' className='img-10' />
                ...
                <div className='row'>
                    ...
                    <div class="col-sm-4 d-flex flext-column  justify-content-center kl fullborder animate__animated animate__bounceInLeft">
                        ...
                        <div className='bull '>
                            ...
                            <img src='assets/img/python-core.png' className='img-1 ' />
                            <img src='assets/img/advanced-python.png' className='img-2' />
                    ...
                    <div class="col-sm-4 d-flex flext-column  justify-content-center kl fullborder animate__animated animate__bounceInRight">
                        ...
                        <div className='bull '>
                            ...
                            <img src='assets/img/django.jpg' className='img-1 ' />
                            <img src='assets/img/flask.jpg' className='img-2' />
                            <img src='assets/img/cherrypy.jpg' className='img-11' />
                ...
                <div className='row'>
                    ...
                    <div class="col-sm-6 d-flex flext-column  justify-content-center kl fullborder">
                        ...
                        <div className='bull '>
                            ...
                            {/* <img src='assets/img/maven.png' className='img-12' /> */}
